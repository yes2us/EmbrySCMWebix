	...
	var titleBar = {
			...
			cols:[
				...
				{ view: "button", type: "iconButton", icon: "external-link", label: "导出", width: 70, 
					click:function(){webix.toExcel($$("dt_dimskc"));}}
		    ]
	};
		...
		rows:[
			{
				...
				columns:[
					...
					{ id:"stocktotalqty",header:[{text:"库存分布",colspan:3},"总库存"],sort:"int",width:85},
					{ id:"stockinstoresqty",header:[null,"门店库存"],sort:"int",width:85},
					{ id:"stockincwhqty",header:[null,"总仓库存"],sort:"int",width:85},
					
					{ id:"stadayofinventory",header:[{text:"分析数据",colspan:8},"库存天数"],sort:"int",width:85},
					{ id:"saletotaldiscount",header:[null,"总折扣"],sort:"int",width:70,format:function(value){return parseInt(100*value)+"%";}},
					{ id:"sale14discount",header:[null,"14天折扣"],sort:"int",width:85,format:function(value){return parseInt(100*value)+"%";}},
